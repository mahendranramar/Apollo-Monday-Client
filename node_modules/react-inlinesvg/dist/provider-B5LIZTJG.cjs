...
const CacheContext = (0, react.createContext)(null);
function CacheProvider({ children, name }) {
	const [store] = (0, react.useState)(() => new CacheStore({
		name,
		persistent: true
	}));
	return /* @__PURE__ */ react.default.createElement(CacheContext.Provider, { value: store }, children);
}
function useCacheStore() {
	return (0, react.useContext)(CacheContext);
}
//#endregion
...
Object.defineProperty(exports, "isSupportedEnvironment", {
	enumerable: true,
	get: function() {
...
//# sourceMappingURL=provider-B5LIZTJG.cjs.map