...
export var ContentColorByName;
(function (ContentColorByName) {
    ContentColorByName["GRASS_GREEN"] = "grass_green";
    ContentColorByName["DONE_GREEN"] = "done-green";
    ContentColorByName["BRIGHT_GREEN"] = "bright-green";
    ContentColorByName["SALADISH"] = "saladish";
    ContentColorByName["EGG_YOLK"] = "egg_yolk";
    ContentColorByName["WORKING_ORANGE"] = "working_orange";
    ContentColorByName["DARK_ORANGE"] = "dark-orange";
    ContentColorByName["PEACH"] = "peach";
    ContentColorByName["SUNSET"] = "sunset";
    ContentColorByName["STUCK_RED"] = "stuck-red";
    ContentColorByName["DARK_RED"] = "dark-red";
    ContentColorByName["SOFIA_PINK"] = "sofia_pink";
    ContentColorByName["LIPSTICK"] = "lipstick";
    ContentColorByName["BUBBLE"] = "bubble";
    ContentColorByName["PURPLE"] = "purple";
    ContentColorByName["DARK_PURPLE"] = "dark_purple";
    ContentColorByName["BERRY"] = "berry";
    ContentColorByName["DARK_INDIGO"] = "dark_indigo";
    ContentColorByName["INDIGO"] = "indigo";
    ContentColorByName["NAVY"] = "navy";
    ContentColorByName["BRIGHT_BLUE"] = "bright-blue";
    ContentColorByName["DARK_BLUE"] = "dark-blue";
    ContentColorByName["AQUAMARINE"] = "aquamarine";
    ContentColorByName["CHILI_BLUE"] = "chili-blue";
    ContentColorByName["RIVER"] = "river";
    ContentColorByName["WINTER"] = "winter";
    ContentColorByName["EXPLOSIVE"] = "explosive";
    ContentColorByName["AMERICAN_GRAY"] = "american_gray";
    ContentColorByName["BLACKISH"] = "blackish";
    ContentColorByName["BROWN"] = "brown";
    ContentColorByName["ORCHID"] = "orchid";
    ContentColorByName["TAN"] = "tan";
    ContentColorByName["SKY"] = "sky";
    ContentColorByName["COFFEE"] = "coffee";
    ContentColorByName["ROYAL"] = "royal";
    ContentColorByName["TEAL"] = "teal";
    ContentColorByName["LAVENDER"] = "lavender";
    ContentColorByName["STEEL"] = "steel";
    ContentColorByName["LILAC"] = "lilac";
    ContentColorByName["PECAN"] = "pecan";
})(ContentColorByName || (ContentColorByName = {}));
/**
 * @deprecated
 */
export var StateSelectedColor;
(function (StateSelectedColor) {
    StateSelectedColor["POSITIVE"] = "positive";
    StateSelectedColor["NEGATIVE"] = "negative";
    StateSelectedColor["PRIMARY"] = "primary";
    StateSelectedColor["WARNING"] = "warning";
})(StateSelectedColor || (StateSelectedColor = {}));
/**
 * @deprecated
 */
export var StateSelectedHoverColor;
(function (StateSelectedHoverColor) {
    StateSelectedHoverColor["POSITIVE"] = "positive";
    StateSelectedHoverColor["NEGATIVE"] = "negative";
    StateSelectedHoverColor["PRIMARY"] = "primary";
})(StateSelectedHoverColor || (StateSelectedHoverColor = {}));
//# sourceMappingURL=colors-vars-map.js.map