...
import { type IComboboxCategory, type IComboboxOption, type IComboboxCategoryMap, type IComboboxItem, type IOptionItemRendererArgs, type IComboboxOptionEvents } from "../components/ComboboxConstants";
...
export declare function useKeyboardNavigation({ defaultVisualFocusFirstIndex, inputRef, onClick, isChildSelectable, options, getOptionId }: {
    ...
    onOptionClick: (event: React.KeyboardEvent | React.MouseEvent, index: number) => void;
};
