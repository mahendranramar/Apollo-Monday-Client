...
export type BaseDropdownProps<Item extends BaseItemData<Record<string, unknown>>> = VibeComponentProps & BoxModeConstraint & {
    /**
...
export type DropdownMultiControllerProps<Item extends BaseItemData<Record<string, unknown>>> = Omit<BaseDropdownProps<Item>, keyof MultiSelectSpecifics<Item> | keyof BoxModeConstraint> & BoxModeConstraint & MultiSelectSpecifics<Item> & {
    dropdownRef: React.Ref<HTMLDivElement>;
};
export type DropdownSingleControllerProps<Item extends BaseItemData<Record<string, unknown>>> = Omit<BaseDropdownProps<Item>, keyof SingleSelectSpecifics<Item> | keyof BoxModeConstraint> & BoxModeConstraint & SingleSelectSpecifics<Item> & {
    dropdownRef: React.Ref<HTMLDivElement>;
};
export {};
