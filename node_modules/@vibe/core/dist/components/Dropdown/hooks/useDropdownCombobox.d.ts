...
declare function useDropdownCombobox<T extends BaseItemData<Record<string, unknown>>>(options: DropdownGroupOption<T>, isMenuOpen?: boolean, autoFocus?: boolean, closeMenuOnSelect?: boolean, defaultValue?: T, value?: T, inputValueProp?: string, onChange?: (option: T | T[] | null) => void, onInputChange?: (value: string | null) => void, onMenuOpen?: () => void, onMenuClose?: () => void, onOptionSelect?: (option: T) => void, filterOption?: (option: T, inputValue: string) => boolean, showSelectedOptions?: boolean, id?: string, inlineSelectedValue?: boolean): {
    isOpen: boolean;
    inputValue: string;
    ...
    getInputProps: (options?: Parameters<(<Options>(options?: import("downshift").UseComboboxGetInputPropsOptions & Options, otherOptions?: import("downshift").GetPropsCommonOptions) => import("downshift").Overwrite<import("downshift").UseComboboxGetInputPropsReturnValue, Options>)>[0]) => import("downshift").Overwrite<import("downshift").UseComboboxGetInputPropsReturnValue, {
        ...
        onChange?: import("react").FormEventHandler<HTMLInputElement>;
    ...
    reset: () => void;
    filteredOptions: import("../components/DropdownBaseList/DropdownBaseList.types").DropdownListGroup<T>[];
    openMenu: () => void;
    toggleMenu: () => void;
    closeMenu: () => void;
};
